class Ride:
    def __init__(self, id, departure_time, arrival_time, user_id, address_1, campus, to_campus, nr_seats, p1, p2, p3):
    ...
    def to_dict(self):
        return {'id': self.id, 'departure_time': self.departure_time, 'arrival_time': self.arrival_time,
                ...
                'to_campus': self.to_campus, 'nr_seats': self.nr_seats, 'pickup_1': self.pickup_1,
                'pickup_2': self.pickup_2, 'pickup_3': self.pickup_3}
